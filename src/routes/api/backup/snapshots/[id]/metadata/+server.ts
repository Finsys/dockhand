...
/**
 * GET /api/backup/snapshots/{id}/metadata - Get a snapshot's stored metadata
 *
 * @openapi
 ...
 * path: id:string! Restic snapshot id (from GET /api/backup/snapshots)
 ...
 * resp-500: Failed to read the snapshot metadata (restic error)
 */
